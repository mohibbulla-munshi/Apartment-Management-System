...
<div class="body flex-grow-1 px-3">
  <div class="container-lg">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('owners.store') }}" class="row g-3 needs-validation" novalidate>
          @csrf
            ...
            <div class="col-md-6">
                <label for="permanent_address" class="form-label"><span style="color:red;">*</span> Permanent Address :</label>
