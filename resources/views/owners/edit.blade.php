        ...
        <div class="card shadow p-3 mb-5 bg-body rounded" style="border:none;">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('owners.update', $owner->id) }}"
                    ...
                    <div class="col-md-6">
                        <label for="contact_no" class="form-label"><span style="color:red;">*</span> Contact No
                            :</label>
                    ...
                    <div class="col-md-6">
                        <label for="password" class="form-label"><span style="color:red;">*</span> Password
                            :</label>
                    ...
                    <div class="col-md-6">
                        <label for="present_address" class="form-label"><span style="color:red;">*</span> Present
                            Address :</label>
                    ...
                    <div class="col-md-6">
                        <label for="permanent_address" class="form-label"><span style="color:red;">*</span>
                    ...
                    <div class="col-md-6">
                        <label for="nid" class="form-label"><span style="color:red;">*</span> NID (National ID Card)
                            :</label>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="border p-2">
                          @foreach($floorUnits as $floorUnit)
                              <input type="checkbox" id="owner_unit_no_{{ $floorUnit->unit_name }}" name="owner_unit_no[]"
                                     value="{{ $floorUnit->unit_name }}" 
                                     {{ in_array($floorUnit->unit_name, explode(',', $owner->owner_unit_no)) ? 'checked' : '' }}>
                              <label for="owner_unit_no_{{ $floorUnit->unit_name }}"> {{ $floorUnit->unit_name }}</label><br>
                          @endforeach
                          <div class="invalid-feedback">
                          </div>
                      </div>
                ...
                $.ajax({
                    ...
                    success: function (unit) {
                        ...
                        $.each(unit, function (key, value) {
                            $("#unit_name").append('<option value="' + value.unit_name + '">' + value.unit_name +
                                '</option>'); // Fixed the concatenation
                        });
                    },
                });
            } else {
