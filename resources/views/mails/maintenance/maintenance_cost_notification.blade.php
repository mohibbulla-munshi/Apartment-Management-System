                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                      ...
                      <h2>Dear Concern,</h2>
                      <p>A maintenance cost of ${{ $cost }} has been added to the system.</p>
                      <p>Thank you for your attention.</p>
                      <p>Regards,</p>
                      <p>Your System Administrator</p>
                      </p>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td class="content-block"
                  ...
                  <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Pondit,
                    Job Mangement System, Dhaka 1207</span>
              ...
              <tr>
                <td class="content-block powered-by"
                  ...
                  Powered by <a href="http://htmlemail.io"
                    style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">Batch 06</a>.
                </td>
              </tr>
            </table>
          </div>
