...
<div class="body flex-grow-1 px-3">
  <div class="container-lg">
    ...
    <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('bill.update', ['bill' => $bill->id]) }}" class="row g-3 needs-validation" novalidate>
            @csrf
            @method('PUT')
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input name="bill_deposit_date" type="date" class="form-control" id="bilDepositDate" value="{{ $bill->bill_deposit_date }}" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              ...
              <input name="total_amount" type="text" class="form-control" id="totalMonth" value="{{ $bill->total_amount }}" required>
            ...
            <div class="col-md-6">
              ...
              <input name="deposit_bank_name" type="text" class="form-control" id="depositBankName" value="{{ $bill->deposit_bank_name }}" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
            <div class="col-md-12">
              ...
              <textarea name="details" class="form-control" value="{{ $bill->details }}" placeholder="Leave a comment here" id="details"></textarea>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
