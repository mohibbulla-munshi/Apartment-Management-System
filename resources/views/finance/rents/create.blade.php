      ...
      <div class="card-body">
        <form class="row g-3 needs-validation" novalidate>
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" id="rentMonth" required>
              <option selected disabled value="">--Select Rent Month--</option>
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" id="rentYear" required>
              <option selected disabled value="">--Select Rent Year--</option>
              <option>2023</option>
              <option>2022</option>
              <option>2021</option>
              <option>2020</option>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="renterName" value="" required>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="rent" value="" required>
            <div class="valid-feedback">
              Looks good!
            </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="date" class="form-control" id="billPainDate" required>
            <div class="invalid-feedback">
              Please provide a valid Date.
            </div>
          </div>
