...
<div class="body flex-grow-1 px-3">
  <div class="container-lg">
    ...
    <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('maintenance.update', ['maintenance' => $MaintenanceCost->id]) }}" class="row g-3 needs-validation" novalidate>
            @csrf
            @method('PUT')
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <select name="month" class="form-select" id="month" required>
                ...
                <option value="september" {{ $MaintenanceCost->month == 'september' ? 'selected' : '' }}>September</option>
            ...
            <div class="col-md-6">
              ...
              <input name="maintenance_title" type="text" class="form-control" id="maintentanceTitle" value="{{ $MaintenanceCost->maintenance_title }}" required>
            ...
            <div class="col-md-6">
              ...
              <input name="amount" type="number" class="form-control" id="amount" value="{{ $MaintenanceCost->amount }}" required>
              <div class="valid-feedback">
                Looks good!
              </div>
            </div>
            {{-- <div class="col-md-12">
              ...
              <textarea name="details" value="{{ $MaintenanceCost->details }}" class="form-control" placeholder="Leave a comment here" id="details" ></textarea>
              <div class="valid-feedback">
                Looks good!
              </div> --}}
            </div>
