        ...
        <form method="POST" action="{{ route('visitor.update', ['visitor' => $visitor->id]) }}" class="row g-3 needs-validation"
          ...
          @method('PUT')
            ...
            <div class="col-md-6">
                ...
                <input name="phone" type="number"  class="form-control" id="phone" value = "{{$visitor->phone}}">
                <div class="invalid-feedback">
              </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input name="reference" type="text"  class="form-control" id="phone" value = "{{$visitor->reference}}" placeholder ="Reference">
                <div class="invalid-feedback">
                </div>
            </div>
