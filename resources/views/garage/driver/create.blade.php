...
<div class="body flex-grow-1 px-3">
  <div class="container-lg">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('driver.store') }}" class="row g-3 needs-validation" novalidate>
          @csrf
        ...
        <div class="col-md-6">
            ...
            <input type="text" name = "licence" class="form-control" id="licence" placeholder ="Licence" required>
            <div class="invalid-feedback">
            </div>
        </div>
